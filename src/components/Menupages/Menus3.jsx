...
const bests = [
    ...
    {id:1,name: "Berry Blast", img: m2 },
    {id:2,name: "Tropical Mix", img: m5 },
    {id:3,name: "Green Power", img: m1 },
    {id:4,name: "Earl Grey", img: m6 },
    {id:5,name: "Chamomile", img: m4 },
    {id:6,name: "Peppermint", img: m3 },
